...
describe("draftToMarkdown", function () {
        ...
        blocks: [
          {
            ...
            type: "inline",
            depth: 0,
            inlineStyleRanges: [{ offset: 5, length: 10, style: "BOLD" }],
            entityRanges: [],
            data: {},
          },
        ],
        ...
        blocks: [
          {
            ...
            type: "unstyled",
            depth: 0,
            inlineStyleRanges: [{ offset: 6, length: 20, style: "BOLD" }],
            entityRanges: [],
            data: {},
          },
        ],
        ...
        blocks: [
          {
            ...
            depth: 0,
            inlineStyleRanges: [
              { offset: 0, length: 10, style: "ITALIC" },
              { offset: 5, length: 9, style: "BOLD" },
            ],
            entityRanges: [],
            data: {},
          },
  ...
  describe("entity conversion", function () {
          ...
          blocks: [
            {
              depth: 0,
              type: "unstyled",
              text: "Hello I am some inline code",
              entityRanges: [],
              inlineStyleRanges: [{ offset: 6, length: 21, style: "CODE" }],
            },
          ],
        };
        /* eslint-enable */
          ...
          blocks: [
            {
              depth: 0,
              type: "unstyled",
              text: "Hello I am bold yay",
              entityRanges: [],
              inlineStyleRanges: [{ offset: 6, length: 9, style: "BOLD" }],
            },
          ],
        };
        /* eslint-enable */
          ...
          blocks: [
            {
              depth: 0,
              type: "unstyled",
              text: "Hello There, I am italic yay",
              entityRanges: [],
              inlineStyleRanges: [{ offset: 12, length: 12, style: "ITALIC" }],
            },
          ],
        };
        /* eslint-enable */
          ...
          blocks: [
            {
              ...
              entityRanges: [],
              inlineStyleRanges: [
                { offset: 8, length: 14, style: "STRIKETHROUGH" },
              ],
            },
          ],
        };
      ...
      var rawObject = {
        entityMap: {
          ...
          1: {
            type: "LINK",
            mutability: "MUTABLE",
            data: { url: "https://facebook.github.io/draft-js/" },
          },
        },
        blocks: [
          {
            key: "58spd",
            text: "This is a test of a link",
            type: "unstyled",
            depth: 0,
            inlineStyleRanges: [],
            entityRanges: [{ offset: 18, length: 6, key: 0 }],
            data: {},
          },
          {
            key: "9ln6g",
          ...
          {
            key: "3euar",
            text: "And perhaps we should test once more.",
            type: "unstyled",
            depth: 0,
            inlineStyleRanges: [],
            entityRanges: [{ offset: 4, length: 7, key: 1 }],
            data: {},
          },
        ],
      };
        ...
        blocks: [
          {
            ...
            inlineStyleRanges: [],
            entityRanges: [
              { offset: 2, length: 4, key: 0 },
              { offset: 7, length: 4, key: 1 },
            ],
            data: {},
          },
        ],
      ...
      var rawObject = {
        entityMap: {
          ...
          1: {
            type: "LINK",
            mutability: "MUTABLE",
            data: { href: "https://facebook.github.io/draft-js/" },
          },
        },
        blocks: [
          {
    ...
    it("renders “the kitchen sink” correctly", function () {
      ...
      var rawObject = {
        ...
        blocks: [
          ...
          {
            key: "eu8ak",
            text: "First, here's a few bullet points:",
            type: "header-two",
            depth: 0,
            inlineStyleRanges: [],
            entityRanges: [],
          ...
          {
            key: "9o0hn",
            text: "And then... some monospace text?\nOr... italics?",
            type: "unstyled",
            depth: 0,
            inlineStyleRanges: [
              { offset: 12, length: 19, style: "CODE" },
              { offset: 39, length: 8, style: "ITALIC" },
            ],
            entityRanges: [],
            data: {},
          },
    ...
    it("renders complex nested items correctly", function () {
      ...
      rawObject = {
          ...
          0: {
            ...
            data: {
              mention: {
                name: "Bran Stark",
                avatar:
                  "https://d1ojh8nvjh9gcx.cloudfront.net/accounts/168181/2e4bff18a328c50404c411c04e608a32a967b1a2/large_2x.png",
                link: null,
                id: 168181,
              },
            },
        ...
        blocks: [
          {
            key: "bkvjj",
            text: "asdadd adasdasd Bran Stark sadadsadasddasdasdasdsadsadasdsadasdasdasdsa",
            type: "unstyled",
            depth: 0,
            inlineStyleRanges: [
              { offset: 7, length: 9, style: "BOLD" },
              { offset: 27, length: 27, style: "BOLD" },
              { offset: 38, length: 7, style: "ITALIC" },
              { offset: 63, length: 8, style: "ITALIC" },
            ],
            entityRanges: [{ offset: 16, length: 10, key: 0 }],
            data: {},
          },
        ],
      };
      ...
      expect(markdown).toEqual(
        "asdadd **adasdasd** [Bran Stark](@168181) **sadadsadasd_dasdasd_asdsadsad**asdsadasd_asdasdsa_"
      );
      ...
      rawObject = {
        ...
        blocks: [
          {
            key: "42pht",
            text: "jkhkhj Bran Stark  khkjj",
            type: "unstyled",
            depth: 0,
            inlineStyleRanges: [{ offset: 0, length: 17, style: "BOLD" }],
            entityRanges: [{ offset: 7, length: 10, key: 0 }],
            data: {},
          },
        ],
      };
    ...
    it("respects shouldOmitContent parameter", function () {
      /* eslint-disable */
      var rawObject = {
        entityMap: {},
        blocks: [
      ...
      var markdown = draftToMarkdown(rawObject, {
        entityItems: {
          mention: {
            ...
            shouldOmitContent: true,
          },
        },
      });

      expect(markdown).toEqual("**jkhkhj [](@168181)**  khkjj");
    });
    ...
    it("renders complex nested items correctly using entityItems block parameters", function () {
      ...
      var rawObject = {
        blocks: [
          {
            key: "2h685",
            text: "A mention in code block @Christophe Hamerling",
            type: "code-block",
            depth: 0,
            inlineStyleRanges: [],
            entityRanges: [{ offset: 24, length: 21, key: 0 }],
            data: { language: "" },
          },
          {
            key: "34o22",
            text: "A mention in unstyled block @Loris Hamerling",
            type: "unstyled",
            depth: 0,
            inlineStyleRanges: [],
            entityRanges: [{ offset: 28, length: 16, key: 1 }],
            data: {},
          },
        ],
        entityMap: {
          0: {
            ...
            data: { mention: { id: "8cb18514-a9be-11eb-abce-0242ac120005" } },
          },
          1: {
            type: "mention",
            mutability: "IMMUTABLE",
            data: { mention: { id: "8cb18514-a9be-11eb-abce-0242ac120006" } },
          },
        },
      };
      /* eslint-enable */
    ...
    it("renders custom items correctly", function () {
        ...
        blocks: [
          {
            ...
            depth: 0,
            inlineStyleRanges: [
              { offset: 0, length: 3, style: "red" },
              { offset: 3, length: 3, style: "orange" },
              { offset: 6, length: 5, style: "yellow" },
            ],
            entityRanges: [],
            data: {},
          },
      ...
      expect(markdown).toEqual(
        '<span style="color: red">One</span><span style="color: orange">Two</span><span style="color: yellow">Three</span>'
      );
    });
    ...
    it("renders complex nested ordered lists", function () {
      ...
      var rawObject = {
        ...
        blocks: [
          ...
          {
            key: "bni48",
            text: "Test item one nested under test item four",
            type: "ordered-list-item",
            depth: 1,
            inlineStyleRanges: [],
            entityRanges: [],
          ...
          {
            key: "d3g6c",
            text: "Test item one double nested",
            type: "ordered-list-item",
            depth: 2,
            inlineStyleRanges: [],
            entityRanges: [],
          ...
          {
            key: "cshu1",
            text: "Test item two double nested",
            type: "ordered-list-item",
            depth: 2,
            inlineStyleRanges: [],
            entityRanges: [],
    ...
    it("resets ordered lists count when list is interupted by another element", function () {
      ...
      var rawObject = {
        ...
        blocks: [
          {
            key: "8omhg",
            text: "first top level list item",
            type: "ordered-list-item",
            depth: 0,
            inlineStyleRanges: [],
            entityRanges: [],
          ...
          {
            key: "d8k17",
            text: "second top level list item",
            type: "ordered-list-item",
            depth: 0,
            inlineStyleRanges: [],
            entityRanges: [],
          ...
          {
            key: "b5fol",
            text: "another top level list item",
            type: "ordered-list-item",
            depth: 0,
            inlineStyleRanges: [],
            entityRanges: [],
    ...
    it("escapes inline markdown characters", function () {
      ...
      var rawObject = {
        ...
        blocks: [
          {
            key: "dvfr1",
            text: "Test _not italic_ Test **not bold**",
            type: "unstyled",
            depth: 0,
            inlineStyleRanges: [],
            entityRanges: [],
      ...
      var markdown = draftToMarkdown(rawObject);
      expect(markdown).toEqual(
        "Test \\_not italic\\_ Test \\*\\*not bold\\*\\*"
      );
    });
    ...
    it("escapes complex inline markdown characters", function () {
      ...
      var rawObject = {
        ...
        blocks: [
          {
            key: "dvfr1",
            text: "Test _not **i** t**a**lic_ T_est **not bold** _hi_ ok **notmatching* smile!",
            type: "unstyled",
            depth: 0,
            inlineStyleRanges: [],
            entityRanges: [],
      ...
      var markdown = draftToMarkdown(rawObject);
      expect(markdown).toEqual(
        "Test \\_not \\*\\*i\\*\\* t**a**lic\\_ T_est \\*\\*not bold\\*\\* \\_hi\\_ ok **notmatching* smile!"
      );
    });
    ...
    it("doesn’t escape inline markdown characters in cases where they aren’t valid as markdown", function () {
      ...
      var rawObject = {
        ...
        blocks: [
          {
            key: "dvfr1",
            text: "Test_not italic_ Test**not bold**",
            type: "unstyled",
            depth: 0,
            inlineStyleRanges: [],
            entityRanges: [],
      ...
      rawObject = {
        ...
        blocks: [
          {
            key: "dvfr1",
            text: "Test _not italic Test not bold",
            type: "unstyled",
            depth: 0,
            inlineStyleRanges: [],
            entityRanges: [],
    ...
    it("doesn’t escape markdown characters in inline code blocks", function () {
      ...
      var rawObject = {
        ...
        blocks: [
          {
            key: "dvfr1",
            text: "such special code which contains *special* chars is so important",
            type: "unstyled",
            depth: 0,
            inlineStyleRanges: [{ offset: 5, length: 43, style: "CODE" }],
            entityRanges: [],
            data: {},
          },
        ],
      ...
      var markdown = draftToMarkdown(rawObject);
      expect(markdown).toEqual(
        "such `special code which contains *special* chars` is so important"
      );
    });
    ...
    it("doesn’t escape markdown characters in code blocks", function () {
      ...
      var rawObject = {
        ...
        blocks: [
          {
            key: "dvfr1",
            text: "such special _code_ which contains *special* chars *wow*",
            type: "code-block",
            depth: 0,
            inlineStyleRanges: [],
            entityRanges: [],
